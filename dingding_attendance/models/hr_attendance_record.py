...
class HrAttendanceRecord(models.Model):
    ...
    planId = fields.Many2one(comodel_name='hr.dingding.plan', string=u'排班', index=True)
    ...
    userCheckTime = fields.Datetime(string="实际打卡时间", required=True, help="实际打卡时间,  用户打卡时间的毫秒数")
