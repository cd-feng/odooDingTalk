...
class HrEmployee(models.Model):
    ...
    din_jobnumber = fields.Char(string='员工工号', tracking=True)
    ding_avatar_url = fields.Char('头像url')
    hired_date = fields.Date(string='入职时间', tracking=True)
    ...
    work_status = fields.Selection(string=u'入职状态', selection=[('1', '待入职'), ('2', '在职'), ('3', '离职')], default='2', tracking=True)
    office_status = fields.Selection(string=u'在职子状态', selection=OfficeStatus, default='-1', tracking=True)
