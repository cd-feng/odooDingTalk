...
class DingTalkCallBackManage(Home, http.Controller):

    @http.route('/web/dingtalk/callback/do', type='json', auth='none', methods=['POST'], csrf=False)
    def dingtalk_callback_controller(self, **kw):
