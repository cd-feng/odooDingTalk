odoo.define('dingtalk.mc.approval.template.buttons', function (require) {
    "use strict";
    ...
    viewRegistry.add('dingtalk_approval_tem_tree', DingTalkApprovalTemplateTreeListView);
    ...
    viewRegistry.add('dingtalk_approval_tem_kanban', DingTalkApprovalTemplateKanbanView);
});
